      ...
      <div className="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 w-full ">
        ...
        <tbody>
            ...
            <tr className="flex justify-between items-center">
                <td><img src="/profile1.png" className="h-[109px] w-[105px]"/></td>
                <td><span>001</span></td>
                <td>Jordan Joseph</td>
                <td>randomemail@gmail.com</td>
                <td><button className="bg-[#b0e1b7] px-6 py-1 me-6">Edit</button><button className="bg-[#ef9999] px-6 py-1">Delete</button></td>
            </tr>
            </div>
        </tbody>
      </div>
